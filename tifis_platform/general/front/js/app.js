...
},{"../../node_modules/material-design-lite/material.js":19,"./GroupModule/":3,"./LoginModule/":6,"./UserModule/":7,"jquery":17,"js-cookie":18}],2:[function(require,module,exports){
...
buf.push("<li data-groupmodule-section=\"group_item\" class=\"group-section__list__item\"><a href=\"#\" class=\"group-section__list__item__link\"></a></li>");;return buf.join("");
};
...
var _utilPeriodApiJs = require('../util/period-api.js');

var _utilPeriodApiJs2 = _interopRequireDefault(_utilPeriodApiJs);

var _utilUserApiJs = require('../util/user-api.js');

var _utilUserApiJs2 = _interopRequireDefault(_utilUserApiJs);

var _utilSignatureApiJs = require('../util/signature-api.js');

var _utilSignatureApiJs2 = _interopRequireDefault(_utilSignatureApiJs);

var _utilGroupApiJs = require('../util/group-api.js');

var _utilGroupApiJs2 = _interopRequireDefault(_utilGroupApiJs);

var _utilSpinnerJs = require('../util/spinner.js');

var _utilSpinnerJs2 = _interopRequireDefault(_utilSpinnerJs);
...
function GroupModule() {
  ...
  var signatureApi;
  var groupApi;
  var spinnerLoader = new _utilSpinnerJs2['default']('[data-groupmodule-section="spinner_container"]', ['u--height-lost', 'u--margin-lost'], '[data-groupmodule-section="spinner"]', 'u--height-lost');

  if ($('[data-usermodule="user_nav"]').length) {
    userApi = new _utilUserApiJs2['default']();
  }
  ...
  $newPeriodForm.submit(function (event) {
    ...
    periodApi.newPeriod(xhrData).then(function (response) {
      closeForm();
      periodApi.findPeriods().then(function (data) {
        spinnerLoader.handlerSpinner();
        renderPeriods(data);
...
},{"../util/group-api.js":8,"../util/period-api.js":10,"../util/signature-api.js":11,"../util/spinner.js":12,"../util/user-api.js":13,"./group-list-item/template.jade":2,"./period-list-item/template.jade":4,"./signature-list-item/template.jade":5,"hammerjs":15,"jquery":17,"js-cookie":18}],4:[function(require,module,exports){
var jade = require("jade/runtime");
...
buf.push("<li data-groupmodule-section=\"period_item\" class=\"period-section__list__item\"><a href=\"#\" class=\"period-section__list__item__link\"></a></li>");;return buf.join("");
};
...
buf.push("<li data-groupmodule-section=\"signature_item\" class=\"signature-section__list__item\"><a href=\"#\" class=\"signature-section__list__item__link\"><span data-groupmodule-span=\"name\" class=\"signature-section__list__item__link__name\"></span><span data-groupmodule-span=\"career\" class=\"signature-section__list__item__link__career\"></span></a></li>");;return buf.join("");
};
...
/**
 * LoginModule()
 * This function provides functionality for loginModule views.
 *
 */
function LoginModule() {

  //functionality for professor button.
  var $btnProfessor = $('[data-loginmodule-btn="professor"]');
  ...
  var $btnStudent = $('[data-loginmodule-btn="student"]');
  ...
  var $registerForm = $('[data-loginmodule-form-registry="form"]');
  $registerForm.submit(function (event) {
    event.preventDefault();
    var fragArgs = {
      attribute: 'data-loginmodule-form-registry',
  ...
  var $passwordRepeatField = $('[data-loginmodule-form-registry="password_repeat"]');
  $passwordRepeatField.on('keyup', function (event) {
    ...
    validateFields($('[data-loginmodule-form-registry="password"]').val(), $passwordRepeatField.val(), event, fragArgs);
  });

  //This part of the code is for validate if two emails equals.
  var $emailRepeatField = $('[data-loginmodule-form-registry="email_repeat"]');
  $emailRepeatField.on('keyup', function (event) {
    ...
    validateFields($('[data-loginmodule-form-registry="email"]').val(), $emailRepeatField.val(), event, fragArgs);
  });
  ...
  function openLoginRegisterForm(args) {
    ...
    var $formSectionElement = $('[data-loginmodule-form-registry="container"]');
    var $btnContainerEntity = $('[data-loginmodule-btn-container=' + args.entitySelected + ']');
    var $btnContainerNoEntity = $('[data-loginmodule-btn-container=' + args.entityNoSelected + ']');
  ...
  function setPhrase(key) {
    ...
    $('[data-loginmodule-form-registry="form"]').before(frag);
  ...
  function validateRegistryForm(fragArgs) {
    var form = document.querySelector('[data-loginmodule-form-registry="form"]');
    var email = document.querySelector('[data-loginmodule-form-registry="email"]');
    var repeatEmail = document.querySelector('[data-loginmodule-form-registry="email_repeat"]');
    var username = document.querySelector('[data-loginmodule-form-registry="username"]');
    var password = document.querySelector('[data-loginmodule-form-registry="password"]');
    var repeatPassword = document.querySelector('[data-loginmodule-form-registry="password_repeat"]');
    var enrollment = document.querySelector('[data-loginmodule-form-registry="enrollment"]');
    var name = document.querySelector('[data-loginmodule-form-registry="name"]');
    var lastName = document.querySelector('[data-loginmodule-form-registry="last_name"]');
    var motherLastName = document.querySelector('[data-loginmodule-form-registry="mother_last_name"]');
    var antibotField = document.querySelector('[data-loginmodule-form-registry="username_b"]');
    var accountType = document.querySelector('[data-loginmodule-form-registry="account_type"]');
    var arrayWithErrors = [];
    ...
    for (var i = 0; i < form.attributes.length; i++) {
      if (form.attributes[i].name === 'data-loginmodule-form-registry') {
  ...
  /**
   * setInputTypeAccount()
   * It's work is to set into data-loginmodule-form-registry="account_type"
  ...
  function setInputTypeAccount(value) {
    var field = document.querySelector('[data-loginmodule-form-registry="account_type"]');
...
},{"jquery":17,"js-cookie":18}],7:[function(require,module,exports){
'use strict';
...
function UserModule() {
  if ($('[data-usermodule="user_nav"]').length) {
    var user = new _utilUserApiJs2['default']();
...
},{"../util/user-api.js":13,"jquery":17}],8:[function(require,module,exports){
'use strict';
...
var GroupApi = (function () {
  function GroupApi(username, periodName, signatureName) {
    _classCallCheck(this, GroupApi);

    this._baseUrl = document.location.origin;
    this._groupsUrl = this.baseUrl + '/get-groups/' + username + '/' + periodName + '/' + ('' + signatureName);
  }
  ...
  _createClass(GroupApi, [{
    ...
    value: function findGroups() {
      ...
      return Promise.resolve($.get(this.groupsUrl)).then(function (data) {
    ...
    key: 'selectedGroup',
    value: function selectedGroup(nameUrl) {
...
var PathApi = (function () {
  function PathApi() {
    _classCallCheck(this, PathApi);
...
var PeriodApi = (function () {
  function PeriodApi(username) {
    _classCallCheck(this, PeriodApi);
  ...
  _createClass(PeriodApi, [{
    key: 'findPeriods',
    value: function findPeriods() {
    ...
    key: 'newPeriod',
    value: function newPeriod(data) {
      return Promise.resolve($.post(this.newPeriodUrl, data)).then(function (response) {
        return response;
      });
    }
  }, {
    key: 'selectedPeriod',
    value: function selectedPeriod(periodName) {
    ...
    value: function saveCurrentPeriod(period) {
      if (sessionStorage['currentPeriod']) {
    ...
    key: 'chooseCurrentPeriod',
    value: function chooseCurrentPeriod(data, period) {
      var currentPeriod;
      for (var i = 0; i < data.length; i++) {
...
},{"./path.js":9,"jquery":17}],11:[function(require,module,exports){
'use strict';
...
var SignatureApi = (function () {
  function SignatureApi(username, periodUrlName) {
    _classCallCheck(this, SignatureApi);

    this._baseUrl = document.location.origin;
    this._signaturesUrl = this.baseUrl + '/get-signatures/' + username + '/' + ('' + periodUrlName);
  }

  _createClass(SignatureApi, [{
    key: 'findSignatures',
    value: function findSignatures() {
      if (sessionStorage['signatures']) {
        sessionStorage.removeItem('signatures');
      }
      return Promise.resolve($.get(this.signaturesUrl)).then(function (data) {
...
},{"./path.js":9,"jquery":17}],12:[function(require,module,exports){
'use strict';
...
var SpinnerLoader = (function () {
  function SpinnerLoader(spinnerContainer, spinnerContainerClass, spinner, spinnerClass) {
    _classCallCheck(this, SpinnerLoader);
  ...
  _createClass(SpinnerLoader, [{
    key: 'handlerSpinner',
    value: function handlerSpinner() {
...
var UserApi = (function () {
  ...
  _createClass(UserApi, [{
    key: 'deleteSessionStorageItem',
    value: function deleteSessionStorageItem() {
    ...
    value: function getUserData() {
      ...
      var data = undefined;
      if (!sessionStorage['user']) {
        return Promise.resolve($.get(this.userUrl)).then(function (response) {
          sessionStorage.setItem('user', JSON.stringify(response));
          _this.saveValues(response);
    ...
    set: function set(fatherLastName) {
    ...
    set: function set(motherLastName) {
