...
function LoginModule() {
  ...
  var $passwordRepeatField =
    $('[data-loginmodule-form-registry="password_repeat"]');
  $passwordRepeatField.on('keyup', (event) => {
    ...
    validateFields($('[data-loginmodule-form-registry="password"]').val(),
  ...
  $emailRepeatField.on('keyup', (event) => {
    ...
    validateFields($('[data-loginmodule-form-registry="email"]').val(),
  ...
  function openLoginRegisterForm(args) {
    ...
    var $btnContainerEntity =
      $('[data-loginmodule-btn-container=' + args.entitySelected + ']');
    var $btnContainerNoEntity =
      $('[data-loginmodule-btn-container=' + args.entityNoSelected + ']');
  ...
  function validateRegistryForm(fragArgs) {
    var form =
      document.querySelector('[data-loginmodule-form-registry="form"]');
    var email =
      document.querySelector('[data-loginmodule-form-registry="email"]');
    var repeatEmail =
      document.querySelector('[data-loginmodule-form-registry="email_repeat"]');
    var username =
      document.querySelector('[data-loginmodule-form-registry="username"]');
    var password =
      document.querySelector('[data-loginmodule-form-registry="password"]');
    var repeatPassword =
      document
        .querySelector('[data-loginmodule-form-registry="password_repeat"]');
    var enrollment =
      document.querySelector('[data-loginmodule-form-registry="enrollment"]');
    var name =
      document.querySelector('[data-loginmodule-form-registry="name"]');
    var lastName =
      document.querySelector('[data-loginmodule-form-registry="last_name"]');
    var motherLastName =
      document
        .querySelector('[data-loginmodule-form-registry="mother_last_name"]');
    var antibotField =
      document.querySelector('[data-loginmodule-form-registry="username_b"]');
    var accountType =
      document.querySelector('[data-loginmodule-form-registry="account_type"]');
    var arrayWithErrors = [];
    var arrayFields = [
      email,
      repeatEmail,
